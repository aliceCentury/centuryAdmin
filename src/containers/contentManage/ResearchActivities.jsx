        ...
        const columns = [
            {
                ...
                render: (text,record) =>{
                  text=text+'';
                    ...
                    return <span>{record.friends}</span>;
                }
            },{
                title: '活动状态',
                dataIndex: 'friends2',
                ...
                render: (text, record) => (
                    <span>
                        <Popconfirm title="确定要开始次活动吗？" onConfirm={this.handleDeleteConfirm.bind(this,record)} onCancel={this.handleDeleteCancel.bind(this)}>
                            <a href="#">开始</a>
                        </Popconfirm>
                             ...
                             <span className="searchBox">
                              <FilterKeyword handleFilter={this.handleFilter.bind(this)} data={this.state.searchOleData} field={["photo_count","starred_count"]}></FilterKeyword>
                                ...
                                <div className="deleteBut">
                                  <ButtonGroup>
                                        <Button  disabled={hasSelected}>进行中</Button>
                                        <Button disabled={hasSelected} type="primary">已经结束</Button>
                                  </ButtonGroup>
                                </div>
